...
import com.example.mychatapp.Notification.APISERVICESHIT;
import com.example.mychatapp.Notification.Client;
import com.example.mychatapp.Notification.Data;
import com.example.mychatapp.Notification.Response;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private void sendMessage(final String myid, final String friendid, final String message) {
        ...
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
                ...
                DatabaseReference dRef = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid());
    ...
    private void sendNotification(final String friendid, final String name, final String msgs) {

        DatabaseReference tokens = FirebaseDatabase.getInstance().getReference("Tokens").child(friendid);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               ...
               // for (DataSnapshot ds: snapshot.getChildren()) {
                ...
                String toototo = shits.getToken();
                    ...
                    Sender sender = new Sender(data, toototo);
